...
-(id)initFromPoint:(CGPoint)centerPoint withDataSource:(id<LNERadialMenuDataSource>)dataSource andDelegate:(id<LNERadialMenuDelegate>)delegate{
	self = [super initWithFrame:CGRectMake([[UIScreen mainScreen] applicationFrame].origin.x, 0, [[UIScreen mainScreen] applicationFrame].size.width, [[UIScreen mainScreen] applicationFrame].size.height+20)];
