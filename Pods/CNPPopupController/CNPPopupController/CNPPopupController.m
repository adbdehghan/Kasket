...
//            self.popupView.center = CGPointMake(self.popupView.center.x, (CGRectGetHeight(self.maskView.frame) - maskViewIntersection.size.height)/2);
            if (self.popupView.frame.origin.y == (self.maskView.frame.size.height - self.popupView.frame.size.height)) {
                self.popupView.frame = CGRectMake(self.popupView.frame.origin.x, self.popupView.frame.origin.y - keyboardFrame.size.height, self.popupView.frame.size.width, self.popupView.frame.size.height);
            }
