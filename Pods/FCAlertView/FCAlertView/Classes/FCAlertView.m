...
- (void)drawRect:(CGRect)rect {
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(15.0f,
                                                                    ...
                                                                    20.0f)];
    titleLabel.font = [UIFont fontWithName:@"IRANSans" size:18];
    ...
    if (_numberOfButtons == 0) { // View only contains DONE/DISMISS Button
        ...
        doneButton.titleLabel.font = [UIFont fontWithName:@"IRANSans" size:18];
        ...
        otherButton.titleLabel.font = [UIFont fontWithName:@"IRANSans" size:18];
        ...
        secondButton.titleLabel.font = [UIFont fontWithName:@"IRANSans" size:16];
